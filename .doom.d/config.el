...
(setq user-full-name "Masood Rezazadeh"
      user-mail-address "rezazadehmasood@gmail.com")
...
;; Key binding for search in current buffer with `swiper
(global-set-key (kbd "C-s") 'swiper)


;; Key bindings for moving betwing windows with Alt + Arrow keys
...
;; Key bindings for resizing windows with Super + Shif + arrow keys
...
;; Key bindings for toggle maximzed windows
(global-set-key (kbd "C-S-SPC") 'win-tg)
(global-set-key (kbd "C-M-SPC") 'balance-windows)
